...
--
-- Host: localhost
-- Generation Time: Apr 30, 2015 at 10:44 AM
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf32 COMMENT='color for different difficulty levels from 0 to 10';

--
-- Dumping data for table `Schwierigkeit`
--

INSERT INTO `Schwierigkeit` (`SchwerID`, `R`, `G`, `B`) VALUES
(3, 255, 0, 0),
(4, 0, 255, 0),
(5, 204, 102, 255);
...
--
ALTER TABLE `MembTypes`
  MODIFY `MembTypeID` tinyint(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `Schwierigkeit`
  MODIFY `SchwerID` tinyint(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
